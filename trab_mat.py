...
#aqui a gente eleva os numeros do array ao quadrado.
# sim, a gente pega os números da primeira lista (list_u_np)
...
# show, agora temos a norma :)


#bora calcular o cosseno
#pra isso a gente pega aquela formula que o prof passou

#cos(theta) = produto escalar / (norma u * norma v)
